...
$(document).ready(function(){
  ...
  <div id="sign_logo_version"> <a href="http://microweber.com" target="_blank"><img src="<?php print mw()->ui->admin_logo_login(); ?>" alt="" width="290" /></a> <span class="mw-sign-version">Beta v. <?php print MW_VERSION; ?></span> </div>
